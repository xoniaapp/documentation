    ...
    <Flex minHeight="100vh" width="full" align="center" justifyContent="center">
      <Box px={4} width="full" maxWidth="500px">
        <Flex mb="4" justify="center">
          <Heading fontSize="24px">#Settings</Heading>
        </Flex>
        <Box p={4} borderRadius={4} background="brandGray.light">
              ...
              {({ isSubmitting, values }) => (
                <Form>
                  ...
                  <Box my={4}>
                    ...
                    <Flex my={8} align="end">
                      <Spacer />
                      <Button mr={4} colorScheme="red" variant="outline" onClick={closeClicked} fontSize="14px">
                        Close
                      </Button>
                      <Button mr={4} colorScheme="red" variant="outline"  fontSize="14px">
                        Delete Account
                      </Button>
                      <LightMode>
          ...
          <Divider my="4" />
          <Flex>
            <Heading fontSize="18px">Security</Heading>
          </Flex>
          <Flex mt="4">
            <Button
        ...
        <a href='https://github.com/xoniaapp'>
          Github
        </a>
      </Box>
